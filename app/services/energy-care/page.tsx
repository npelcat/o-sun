...
const EnergyCare: React.FC = () => {
  ...
  return (
    <div className="text-center py-16 space-y-12">
      ...
      <div className="flex justify-center bg-beige">
        <div className="flex flex-col gap-2 p-8 w-full md:w-3/5">
          <CardTitlePhoto
          ...
          <div className="flex">
            <GiUbisoftSun className="w-6 h-6 pr-2" aria-hidden="true" />
            Les mémoires karmiques bloquées
          </div>
          <br />
          <div className="flex">
            <GiUbisoftSun className="w-6 h-6 pr-2" aria-hidden="true" />
            Les émotions à libérer : stress, anxiété, fatigue, angoisse, colère,
            etc..
          </div>
          <br />
          <div className="flex">
            <GiUbisoftSun className="w-6 h-6 pr-2" aria-hidden="true" />
            Les noeuds énergétiques à libérer
          </div>
          <br />
          <div className="flex">
            <GiUbisoftSun className="w-6 h-6 pr-2" aria-hidden="true" />
            Le nettoyage, la libération des traumatismes (physiques et
            émotionnels).
          </div>
          <br />
          <div className="flex">
          ...
          <div>
            ...
            <Accordion title="Types de séance et tarifs">
              <section className="text-justify">
                ...
                <TextEditor
                  initialText={getPartContent("prestation energetique 1") || ""}
                ...
                <TextEditor
                  initialText={getPartContent("prestation energetique 2") || ""}
                ...
                <TextEditor
                  initialText={getPartContent("prestation energetique 3") || ""}
